                ...
                <div className="unsigned-user__more-info">
                  {
                    ...
                    <div className="unsigned-user__invalid-debut-id">
                      <p>
                        <strong>{username}</strong> is a blockstack user but is <strong>not</strong> using debut!  You can let her know about debut via social proofs below!
                      </p>
                      <p>
                        If all else fails you can always use the Blockstack explorer located <a href={`https://explorer.blockstack.org/name/${username}`} rel="noopener noreferrer" target="_blank">here!</a>
                      </p>
